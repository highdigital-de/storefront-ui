...
or by importing the list of icon sizes from `@highdigital/sharedt/variables/sizes` and using the desired size variable, e.g
...
<script>
  import { sizes } from "@highdigital/sharedt/variables/sizes";
  export default {
    data() {
      return {
        iconSize: sizes.xxs,
